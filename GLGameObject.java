...
public class GLGameObject {
    ...
    private int mtlResourceID;

    public GLGameObject(int resourceID, int mtlResourceID, float intialX, float initialY, float initialZ, float aposXSpeed, float aposYSpeed, float aposZSpeed) {

        this.resourceID = resourceID;
        this.mtlResourceID = mtlResourceID;
    ...
    public int getMtlResourceID() {
        return mtlResourceID;
    }

    public void setMtlResourceID(int mtlResourceID) {
        this.mtlResourceID = mtlResourceID;
    }
}
